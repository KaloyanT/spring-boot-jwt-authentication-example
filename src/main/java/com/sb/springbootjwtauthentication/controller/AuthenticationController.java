package com.sb.springbootjwtauthentication.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.node.ObjectNode;
import com.sb.springbootjwtauthentication.model.entity.User;
import com.sb.springbootjwtauthentication.model.jwt.JwtAuthenticationRequest;
import com.sb.springbootjwtauthentication.model.jwt.JwtAuthenticationResponse;
...
import com.sb.springbootjwtauthentication.security.JwtTokenUtil;
import com.sb.springbootjwtauthentication.util.CustomErrorType;
import com.sb.springbootjwtauthentication.util.StringVerifier;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> authenticationRequest(HttpServletRequest request) {
        ...
        if(!StringVerifier.validString(token) || token.trim().length() < 7) {
            return ResponseEntity.badRequest().body(null);
        }
